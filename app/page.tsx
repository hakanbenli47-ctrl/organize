    ...
    <main className="min-h-screen overflow-x-hidden bg-[#07030f] text-white">
      <section className="relative overflow-hidden">
        <video
          ...
          playsInline
          preload="auto"
          className="absolute inset-0 h-full w-full object-cover opacity-25 sm:opacity-35"
        />

        <div className="absolute inset-0 bg-gradient-to-b from-[#07030f]/95 via-[#10051f]/95 to-[#07030f] lg:bg-gradient-to-r lg:from-[#07030f] lg:via-[#10051f]/90 lg:to-[#07030f]/50" />

        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,rgba(236,72,153,0.22),transparent_32%),radial-gradient(circle_at_85%_20%,rgba(250,204,21,0.14),transparent_28%),radial-gradient(circle_at_50%_90%,rgba(168,85,247,0.22),transparent_34%)]" />

        <div className="relative z-10 mx-auto max-w-7xl px-4 pb-12 pt-10 sm:px-6 sm:py-20 lg:flex lg:min-h-screen lg:items-center lg:py-24">
          <div className="grid w-full items-center gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
            <motion.div
              ...
              className="max-w-3xl"
            >
              <div className="mb-4 inline-flex max-w-full items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-2 text-[11px] font-semibold text-white/80 backdrop-blur-xl sm:mb-6 sm:px-4 sm:text-sm">
              ...
              <h1 className="text-[2.15rem] font-black leading-[1.05] tracking-tight sm:text-6xl lg:text-8xl">
                Konserin
              ...
              <p className="mt-4 max-w-2xl text-[14px] leading-7 text-white/70 sm:mt-7 sm:text-lg sm:leading-8">
              ...
              <div className="mt-6 grid grid-cols-1 gap-3 sm:flex sm:flex-row">
                <a
                  ...
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-yellow-300 via-pink-400 to-purple-500 px-6 text-sm font-black text-black shadow-[0_0_35px_rgba(236,72,153,0.28)] transition hover:scale-[1.03] sm:h-auto sm:px-8 sm:py-4 sm:text-base"
                >
              ...
              <div className="mt-6 grid grid-cols-4 gap-2 sm:mt-10 sm:gap-3">
                {stats.map((item) => (
                  <div
                    key={item.label}
                    className="rounded-2xl border border-white/10 bg-white/10 p-3 text-center backdrop-blur-xl sm:rounded-3xl sm:p-4 sm:text-left"
                  >
              ...
              <div className="mt-6 overflow-hidden rounded-3xl border border-white/10 bg-black/35 p-2 backdrop-blur-xl lg:hidden">
                <div className="relative h-[190px] overflow-hidden rounded-2xl">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 rounded-2xl border border-white/10 bg-black/45 p-3 backdrop-blur">
      ...
      <section className="relative px-4 py-12 sm:px-6 sm:py-24">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-7 max-w-3xl sm:mb-12">
            ...
            <h2 className="text-[1.75rem] font-black leading-tight sm:text-5xl">
              Eğlence, sahne ve organizasyon sürecini güçlü bir marka
              deneyimine dönüştürür.
            </h2>
          </div>

          <div className="grid gap-3 md:grid-cols-3 sm:gap-5">
            {services.map((item) => {
              ...
              return (
                <motion.div
                  key={item.title}
                  whileHover={{ y: -8 }}
                  className="rounded-3xl border border-white/10 bg-white/[0.06] p-4 shadow-2xl backdrop-blur-xl sm:rounded-[2rem] sm:p-7"
                >
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {videos.map((video, index) => (
              ...
              >
                <div className="relative h-[210px] overflow-hidden sm:h-auto sm:aspect-[9/14]">
                  <video
                    src={video}
                    muted
                    loop
      ...
      <section className="relative px-4 py-12 sm:px-6 sm:py-24">
        ...
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl border border-white/10 bg-white/10 p-4 shadow-2xl backdrop-blur-xl sm:rounded-[2.5rem] sm:p-12">
          ...
          <div className="relative grid gap-6 lg:grid-cols-[1fr_0.8fr] lg:items-center sm:gap-10">
            <div>
              <p className="mb-3 inline-flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.2em] text-yellow-300 sm:text-sm sm:tracking-[0.35em]">
            ...
            <div className="rounded-3xl border border-white/10 bg-black/35 p-4 sm:rounded-[2rem] sm:p-6">
